# adjusted to look for higher compatibility with he10 numerical results
library(tidyverse)
#library(dplyr)
library(spatPomp)
...
#' in Park and Ionides (2020).
#' Other transport models may be added.
